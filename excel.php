...
echo "<table border='1' align='center'>";
    ...
    echo "<th colspan='3'>Usuário </th>";
    echo "<th colspan='3'>Setor</th>";
    echo "<th>Entrega</th>";
    echo "<th>Código </th>";
    echo "<th colspan='3'>Produto </th>";
    echo "<th colspan='1'>Durabilidade </th>";
    echo "<th>C.A</th>";
    echo "<th>Excesso</th>";
    echo "<th>Quantidade</th>";
    echo "<th colspan='3'>Funcionário</th>";
    ...
    while($row_tabela_excel = oci_fetch_array($rest_cons_excel)){
     ...
     echo '<tr>';
        ...
        echo '<td class="align-middle" colspan="3">' .  $row_tabela_excel['NM_USU'] . '</td>';
        echo '<td class="align-middle" colspan="3">' .  $row_tabela_excel['NM_SETOR'] . '</td>';
        echo '<td class="align-middle">' .  $row_tabela_excel['HR_CADASTRO'] . '</td>';
        echo '<td class="align-middle">' .  $row_tabela_excel['CD_PRODUTO_MV'] . '</td>';
        echo '<td class="align-middle" colspan="3">' .  $row_tabela_excel['DS_PRODUTO'] . '</td>';
        echo '<td class="align-middle" colspan="1">' .  $row_tabela_excel['DT_DURABILIDADE'] . '</td>';
        echo '<td class="align-middle">' .  $row_tabela_excel['CA_MV'] . '</td>';
        echo '<td class="align-middle">' .  $row_tabela_excel['EX_SOL'] . '</td>';
        echo '<td class="align-middle">' .  $row_tabela_excel['QUANTIDADE'] . '</td>';
        echo '<td class="align-middle" colspan="3">' .  $row_tabela_excel['NM_USUARIO_CADASTRO'] . '</td>';
    echo '</tr>';
