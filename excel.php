...
header("Content-Disposition: attachment; filename=nome_do_arquivo.xls");  ///NOME DO ARQUIVO
...
$consulta_excel_oracle = "SELECT sol.CD_SOLICITACAO,
                                 ...
                                 TO_CHAR(TO_DATE('$data_inial_ex','YYYY-MM-DD')) AND
                                 TO_CHAR(TO_DATE('$data_final_ex','YYYY-MM-DD'))
                                 AND sol.CD_SETOR_MV = '$centro_custo_ex'
                                 AND sol.CD_USUARIO_MV = UPPER('$cd_usuario_relatorio_ex')";
