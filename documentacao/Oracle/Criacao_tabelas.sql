...
DROP TABLE portal_sesmt.ASSINATURA_TERMO;

CREATE TABLE portal_sesmt.ASSINATURA_TERMO(
  CD_ASSINATURA_TERMO INT NOT NULL,
  CRACHA_SOLICITANTE VARCHAR(15) NOT NULL,
  CD_USUARIO_MV_CADASTRO VARCHAR(15) NOT NULL,
  HR_CADASTRO DATE NOT NULL,
  CD_USUARIO_MV_ULT_ALT VARCHAR(15) NULL,
  HR_ULT_ALT DATE NULL,
  BLOB_ASSIN_TERMO BLOB NOT NULL,

  CONSTRAINT PK_CD_ASSINATURA_TERMO PRIMARY KEY (CD_ASSINATURA_TERMO)

);

DROP SEQUENCE portal_sesmt.SEQ_ASSINATURA_TERMO;

CREATE SEQUENCE portal_sesmt.SEQ_ASSINATURA_TERMO
START WITH 1    
INCREMENT BY 1
NOCACHE
NOCYCLE;

SELECT * FROM portal_sesmt.ASSINATURA_TERMO
